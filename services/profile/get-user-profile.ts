...
//   // Obtener los target_ids (pueden ser UUID o TID dependiendo de cómo Drupal los retorne)
...
//   // Buscar los términos de taxonomía en paralelo
//   // Usa 'uuid' si target_id es un string UUID, o 'tid' si es un número
//   const [gender, area, headquarters] = await Promise.all([
//     genderTargetId
//       ? fetchTaxonomyTermById(
//         "/jsonapi/taxonomy_term/gender",
//         genderTargetId,
//         "tid" // Cambia a 'tid' si tu Drupal retorna números en target_id
//       )
//       : null,
//     areaTargetId
//       ? fetchTaxonomyTermById(
//         "/jsonapi/taxonomy_term/area_subarea",
//         areaTargetId,
//         "tid"
//       )
//       : null,
...
//       ? fetchTaxonomyTermById(
//         "/jsonapi/taxonomy_term/headquarters",
//         headquartersTargetId,
//         "tid"
//       )
//       : null,
