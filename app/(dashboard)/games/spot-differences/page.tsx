...
export default function SpotDifferencesPage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Encuentra las Diferencias..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--spot_differences_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <SpotDifferencesGame
        gameDetails={gameDetails as SpotDifferencesGameDetails}
